...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "SHABAN-SOBX-MD~LMEjkBxR#ssmUMvcggHomYCITsdGEOBW1CBMPRYFDFk7n2O11Q0w",
// add your Session Id 
AUTO_STATUS_SEEN: process.env.AUTO_STATUS_SEEN || "false",
// make true or false status auto seen
AUTO_STATUS_REPLY: process.env.AUTO_STATUS_REPLY || "fase",
...
OWNER_NAME: process.env.OWNER_NAME || "HACKER TF",
// add bot owner name
DESCRIPTION: process.env.DESCRIPTION || "*© ᴘᴏᴡᴇʀᴇᴅ ʙʏ Mʀ Sʜᴀʙᴀɴ*",
// add bot owner name    
ALIVE_IMG: process.env.ALIVE_IMG || "https://i.ibb.co/9N1sJ41/Manul-Ofc-X.jpg",
// add img for alive msg
LIVE_MSG: process.env.LIVE_MSG || "> Zinda Hun Yar *Hacker TF*🤠",
// add alive msg here 
